  ...
  return (
    <div className="min-h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
          ...
          {THEMES.map((t) => (
            <button
              ...
              className={`
                ...
                ${theme === t ? "bg-base-200 ring-2 ring-primary" : ""}
              `}
              onClick={() => setTheme(t)}
            >
              <div
        ...
        {/* Preview */}
        <h3 className="text-base font-semibold mt-8">Preview</h3>
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-3 border-b border-base-300 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-base-content/70">Online</div>
                  </div>
                </div>
                ...
                <div className="p-4 space-y-4 min-h-[200px] max-h-[200px] overflow-y-auto bg-base-100">
                  {PREVIEW_MESSAGES.map((msg) => (
                    ...
                    >
                      <div
                        className={`
                          max-w-[80%] rounded-xl p-3 shadow-sm text-sm
                          ${msg.isSent
